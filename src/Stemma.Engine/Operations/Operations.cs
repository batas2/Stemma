...
namespace Stemma.Engine.Operations;
...
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.AddElementOp), "AddElement")]
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.RenameElementOp), "RenameElement")]
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.RemoveElementOp), "RemoveElement")]
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.SetElementContextOp), "SetElementContext")]
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.SetElementAttributeOp), "SetElementAttribute")]
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.AddLinkOp), "AddLink")]
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.RemoveLinkOp), "RemoveLink")]
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.SetLinkAttributeOp), "SetLinkAttribute")]
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.SetLifecycleOp), "SetLifecycle")]
[JsonDerivedType(typeof(Stemma.Engine.ArchModel.SetOwnershipOp), "SetOwnership")]
[JsonDerivedType(typeof(Stemma.Engine.Workspace.RestoreElementOp), "RestoreElement")]
[JsonDerivedType(typeof(Stemma.Engine.Workspace.RestoreLinkOp), "RestoreLink")]
