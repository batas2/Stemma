...
export function ViewSwitcher() {
  ...
  return (
    <div className="inline-flex items-center gap-0.5 bg-zinc-900 border border-zinc-800 rounded-md p-0.5">
      {views.map((v) => {
        const Icon = v.icon;
        ...
        return (
          <button
            ...
            className={clsx(
              ...
              !active && !disabled && 'text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800/60',
