...
/// <summary>
/// Orchestrator for the YAML storage adapter. Loads <c>Concepts/*.stemma.yaml</c>
...
public sealed class YamlAdapter : IStorageAdapter
{
    ...
    public static YamlAdapter Load(string workspaceRoot)
    {
        ...
        foreach (var path in Directory.EnumerateFiles(dir, "*.stemma.yaml", SearchOption.TopDirectoryOnly))
        {
