    ...
    <div className="flex-1 flex items-center justify-center">
      <div className="text-center max-w-md px-6">
        ...
        <p className="text-sm text-zinc-400 mb-6">
          Point Verso at a folder containing a <code className="font-mono text-zinc-300 bg-zinc-900 px-1 rounded">.sln</code> or
          one or more <code className="font-mono text-zinc-300 bg-zinc-900 px-1 rounded">.csproj</code> files.
          Verso will model the type structure live and persist every change to the source files themselves —
          no database.
        </p>
