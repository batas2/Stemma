...
/// <summary>
/// Discovers all rules (built-in [VersoRule] classes plus user-defined rules in the workspace
/// assembly), applies any verso.rules.json overrides, and runs them against an ArchModel.
/// </summary>
...
public sealed class RulesConfig
{
    ...
    {
        var path = Path.Combine(workspaceRoot, "verso.rules.json");
