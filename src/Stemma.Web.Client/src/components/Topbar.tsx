...
export function Topbar() {
  ...
  return (
    <header role="banner" className="h-14 border-b border-default bg-white/85 dark:bg-zinc-950/85 backdrop-blur flex items-center px-4 gap-3 z-chrome relative">
      <a href="/" aria-label="Stemma home" className="flex items-center pr-3 mr-1 border-r border-default hover:opacity-90 transition-opacity">
        <StemmaLockup size={22} showTagline={true} className="hidden sm:flex" />
        <StemmaLockup size={22} showTagline={false} className="sm:hidden" />
      </a>
