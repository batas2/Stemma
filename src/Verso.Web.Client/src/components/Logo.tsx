...
/**
 * The Verso mark — a folded-corner page (the "verso" of the metaphor) with a subtle "V"
 ...
 */
export function VersoMark({ size = 20, className, monochrome = false }: MarkProps & { monochrome?: boolean }) {
  if (monochrome) {
    return (
 ...
 */
export function VersoLockup({ size = 22, showTagline = true, className }: { size?: number; showTagline?: boolean; className?: string }) {
  return (
